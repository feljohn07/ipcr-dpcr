...
<?php if (!empty($tasks)): ?>
    ...
    <?php
    $dotsStatus = getDotsStatus($semester_id, $users_idnumber);
    $totalDots = count($dotsStatus); // Get the total number of dots for conditional logic
    ...
    ?>
        <div style="display: flex; align-items: center; margin-right: 10px; font-size: 12px;" title="<?php echo $tableName; ?>">
            ...
            <?php if ($index < $totalDots - 1): // Add separator for all but the last item ?>
    ...
    <style>
        ...
        <button class="generate-button" onclick="generateForms('<?php echo htmlspecialchars($taskGroup[0]['group_task_id']); ?>', '<?php echo htmlspecialchars($semesterId); ?>')">Generate Forms</button>
        ...
        <tr>
            ...
            <th rowspan="2" style="font-size: 14px; width: 300px;">Success Indicator (Target + Measures)</th> <!-- Increased width -->
        ...
        <tr>
            ...
            foreach ($taskGroup as $task): ?>
                ...
                <tr>
                    ...
                    <td style="width: 300px; padding: 0;"><?php echo nl2br(htmlspecialchars(stripslashes($task['description']))); ?></td> <!-- Adjusted padding -->
                    ...
                    <td style="text-align: center;"> <!-- Center the content of the cell -->
