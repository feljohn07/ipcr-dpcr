...
function exportToWord() {
    ...
    <div class="background-image" style="position: absolute; top: 40; left: 8%; width: 50%; height: 60%; z-index: -1;">
        <?php if (isset($signature_data_office_head) && $signature_data_office_head): ?>
            <img src="data:image/png;base64,<?php echo base64_encode($signature_data_office_head); ?>" alt="Signature" 
                 style="position: absolute; top: 0; left: 0; width: 40%; height: 30%; object-fit: cover; border: none; background-color: transparent;">
        <?php else: ?>
        ...
        <!-- Image container for the background -->
        <div class="background-image-president" style="position: absolute; top: 40; left: 62%; width: 50%; height: 60%; z-index: -1;">
    ...
    <tr>
        <td style="position: relative; padding: 0; height: 15px; border-bottom: none;">
            <strong class="highlighted"><?php echo htmlspecialchars($collegeDean); ?></strong><br>Immediate Supervisor
        </td>
        <td></td>
        <td style="position: relative; padding: 0; height: 15px; border-bottom: none;">
            <strong class="highlighted"><?php echo htmlspecialchars($collegePresident); ?></strong><br>College President
        </td>
        <td></td>
    </tr>
</table>
