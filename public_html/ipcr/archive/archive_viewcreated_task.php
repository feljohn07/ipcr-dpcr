    ...
    <?php if (!empty($tasks)): ?>
        <?php foreach ($tasks as $group_task_id => $taskGroup): ?>
            ...
            <tr>
                ...
                <th rowspan="2" style="font-size: 14px;">Upload</th>
                <th rowspan="2" style="font-size: 14px;">Message</th>
                <th rowspan="2" style="font-size: 14px;">Action</th>
            </tr>
            <tr>
                            ...
                            <form id="ipctraskupload" method="post" enctype="multipart/form-data">
                                ...
                                if ($filesToUpload > 0): 
                                    for ($i = 1; $i <= $filesToUpload; $i++): ?>
                                        <input type="file" name="file[]" accept=".doc, .docx, .xls, .xlsx, .pdf, .jpg, .jpeg, .png, .mp4, .avi, .mov, .mkv">
                                    <?php endfor; ?>
                        ...
                        <td>
                            <button class="edit-button" 
                                onclick="openEditModal(
                                    ...
                                    '<?php echo htmlspecialchars($task['documents_required']); ?>'
                                )">Edit</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
