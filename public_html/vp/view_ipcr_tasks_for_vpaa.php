...
if ($semester_id) {
    ...
    $query = "SELECT t1.*, t2.file_name, t2.file_type, t2.file_content, t1.quality, t1.efficiency, t1.timeliness, t1.average, t1.note_feedback
              ...
              AND EXISTS (SELECT 1 FROM for_ipcr_final_signature f WHERE f.idnumber = t1.idnumber AND f.semester_id = ?)";
            ...
            <div class="user-task-group" style="border: 1px solid #ddd; border-radius: 5px; padding: 15px; margin-bottom: 20px; background-color: #f9f9f9;">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <button class="signature-button" onclick="finalSignature('<?php echo htmlspecialchars($taskGroup[0]['idnumber']); ?>', '<?php echo htmlspecialchars($semester_id); ?>')">Signature</button>
                    </div>
                </div>
