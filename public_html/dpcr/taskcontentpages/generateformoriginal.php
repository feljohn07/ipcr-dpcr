...
if (isset($_GET['semester_id']) && !empty($_GET['semester_id'])) {
    ...
    $semester_stmt = $conn->prepare("SELECT semester_name,start_date, end_date, vpapproval, presidentapproval, userapproval FROM semester_tasks WHERE semester_id = ?");
...
.background-image {
    top: 25%; /* Adjusted to move it higher */
    ...
    <div class="print-container">
        ...
        <div class="container">
            ...
            <table class="review-table">
                ...
                <tr>
                    <td><strong class="highlighted"><?php echo htmlspecialchars($vpaaqa); ?></strong><br>Immediate Supervisor</td>
                    <td></td>
...
// Now render the grouped strategic tasks
    ...
    for ($i = 0; $i < $rowspan; $i++) {
        ...
        <tr>
            ...
            <?php 
                ...
                $description = stripslashes($group['description'][$i]); // Remove escape characters
                $description = str_replace('<break(+)line>', '<br>', $description); // Replace <breakline> with <br>

                // Display the percentage with a descriptive message
                echo htmlspecialchars(round($percentage, 2)) . '% of the target for ' . $description . ' has been accomplished.';
            ?>
            </td>
...
?>
        <tr>
            ...
            <td><?php echo count($strategic_tasks) > 0 ? number_format($totalStrategicAverage / count($strategic_tasks), 2) : '0.00'; ?></td>
            <td></td>
        </tr>
        <tr>
...
?>
        ...
        <tr>
            <td colspan="6" style="text-align: right;"><span>Average Sub-total</span></td>
            <td><?php echo count($core_tasks) > 0 ? number_format($totalCoreAverage / count($core_tasks), 2) : '0.00'; ?></td>
            <td></td>
        </tr>
        <tr>
...
?>
        ...
        <tr>
            <td colspan="6" style="text-align: right;"><span>Average Sub-total</span></td>
            <td><?php echo count($support_tasks) > 0 ? number_format($totalSupportAverage / count($support_tasks), 2) : '0.00'; ?></td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <table class="review-table">
                ...
                <td class="for-signature" style="padding: 0; height: 140px; width: 190px; overflow: hidden; border-bottom: none;">
                    ...
                    <td class="for-signature" style="padding: 0; height: 140px; width: 190px; overflow: hidden; border-bottom: none;">
                        <?php 
                        if ($semester['presidentapproval'] == 1 && $signature_data_president): ?>
                        ...
                        <?php elseif ($semester['presidentapproval'] == null): ?>
                            <p class="no-signature" style="text-align: center;"></p>
                        <?php endif; ?>
                    </td>
                    <td rowspan="3" style="text-align: center; vertical-align: top;">Date</td>
                ...
                <tr>
                    <td style="border-top: none; border-left: 1px solid black; border-right: 1px solid black; padding: 0;">
                       <strong class="highlighted" style="font-size: 12px;"><?php echo strtoupper(htmlspecialchars($_SESSION['firstname']) . ' ' . htmlspecialchars($_SESSION['middlename']) . ' ' . htmlspecialchars($_SESSION['lastname'])); ?></strong>
                    </td>

                    <td style="border-top: none; border-left: 1px solid black; border-right: 1px solid black; padding: 0;">
                        <strong class="highlighted" style="font-size: 12px;"><?php echo strtoupper(htmlspecialchars($vpaaqa)); ?></strong>
                    </td>
                    ...
                    <td style="border-top: none; border-left: 1px solid black; border-right: 1px solid black; padding: 0;">
                        <strong class="highlighted" style="font-size: 12px;"><?php echo strtoupper(htmlspecialchars($collegePresident)); ?></strong>
                    </td>
                </tr>
                <tr>
