...
<h2>Users who submitted froms <?php echo htmlspecialchars($collegeCount); ?> / <?php echo htmlspecialchars($totalUsers); ?></h2>
</div>
...
<button class="signature-button" onclick="saveSignature('<?php echo htmlspecialchars($taskGroup[0]['idnumber']); ?>', '<?php echo htmlspecialchars($semester_id); ?>')">Sign</button>
<?php if ($buttonsVisible): // Show buttons only if the condition is met ?>

<button class="message-button" onclick="openMessageModal('<?php echo htmlspecialchars($taskGroup[0]['idnumber']); ?>')">Send Development Feedback</button>
<?php endif; ?>
<button class="message-button" onclick="viewIpcrMessageModal('<?php echo htmlspecialchars($taskGroup[0]['idnumber']); ?>', '<?php echo htmlspecialchars($semester_id); ?>')">View Development Feedback</button>
<?php if ($hasSemesterEntry): // Only show the button if the user has an entry ?>
<button class="signature-button" onclick="finalSignature('<?php echo htmlspecialchars($userId); ?>', '<?php echo htmlspecialchars($semester_id); ?>')">Final Signature</button>
<?php endif; ?>
</div>
</div>
...
<span style="display: inline-block; width: 10px; height: 10px; border-radius: 50%;
background-color: <?php echo $messageExists[$taskGroup[0]['idnumber']] ? 'blue' : 'gray'; ?>;" title="Message Status"></span>
...
<?php if ($hasSignature): // Only show the table if the user has a signature ?>
<table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
<tr>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center;" rowspan ="2">Area of Evaluation</th>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center;" rowspan ="2">Task Name</th>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center;" rowspan ="2">Description</th>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center; width: auto;" rowspan ="2">Target</th>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center; width: auto;" colspan="4">Rating</th>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center;" rowspan ="2">Uploaded Files</th>
<th style="border: 1px solid #ddd; padding: 0; background-color: #4CAF50; color: white; text-align: center;" rowspan ="2">Note Feedback</th>
<th style="border: 1px solid #ddd; padding: 12px; background-color: #4CAF50; color: white; text-align: center;" rowspan ="2">Action</th>
</tr>
<tr>

<th style="border: 1px solid #ddd; padding: 0; background-color: #4CAF50; color: white; text-align: center; width: auto;">Q</th>
<th style="border: 1px solid #ddd; padding: 0; background-color: #4CAF50; color: white; text-align: center; width: auto;">E</th>
<th style="border: 1px solid #ddd; padding: 0; background-color: #4CAF50; color: white; text-align: center; width: auto;">T</th>
<th style="border: 1px solid #ddd; padding: 0; background-color: #4CAF50; color: white; text-align: center; width: auto;">A</th>
</tr>
<?php
...
<td style="border: 1px solid #ddd; padding: 12px; max-width: 200px; overflow-wrap: break-word; word-wrap: break-word; white-space: normal;">
<?php echo htmlspecialchars($task['task_name']); ?>
</td>
<td style="border: 1px solid #ddd; padding: 12px; max-width: 300px; overflow-wrap: break-word; word-wrap: break-word; white-space: normal;">
<?php echo nl2br(htmlspecialchars($task['description'])); ?>
</td>
<td style="border: 1px solid #ddd; padding: 12px;"><?php echo htmlspecialchars($task['documents_required']); ?></td>
<td style="border: 1px solid #ddd; padding: 2px; text-align: center;"><?php echo htmlspecialchars($task['quality']); ?></td>
<td style="border: 1px solid #ddd; padding: 2px; text-align:center;"><?php echo htmlspecialchars($task['efficiency']); ?></td>
<td style="border: 1px solid #ddd; padding: 2px; text-align: center;"><?php echo htmlspecialchars($task['timeliness']); ?></td>
<td style="border: 1px solid #ddd; padding: 2px; text-align: center;"><?php echo htmlspecialchars($task['average']); ?></td>

<td style="border: 1px solid #ddd; padding: 2px; max-width: 100px; overflow-wrap: break-word; font-size: 12px; padding: 5px;">
<?php
...
<button type="button"
title="Show Note Feedback"
aria-label="Show Note Feedback"
style="background: none; border: none; cursor: pointer;"
data-note-feedback="<?php echo htmlspecialchars($task['note_feedback']); ?>"
onclick="showNoteFeedback(this)">
<i class="fas fa-comment-dots" style="font-size: 24px; color: #007bff;"></i> <!-- Message Icon -->
</button>
<?php else: ?>
...
<td>
<input type="number" id="quality-input" min="0" max="5" placeholder="Enter rating for quality" required style="width: 100%;">
</td>
</tr>
<tr>
<td><label for="efficiency-input">Efficiency:</label></td>
<td>
<input type="number" id="efficiency-input" min="0" max="5" placeholder="Enter rating for efficiency" required style="width: 100%;">
</td>
</tr>
<tr>
<td><label for="timeliness-input">Timeliness:</label></td>
<td>
<input type="number" id="timeliness-input" min="0" max="5" placeholder="Enter rating for timeliness" required style="width: 100%;">
</td>
</tr>
</table>
