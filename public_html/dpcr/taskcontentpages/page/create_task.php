...
<form id="createTaskForm">
    <fieldset>
        ...
        <input type="text" id="college" name="college" style="width : 230px;"
            value="<?php echo $_SESSION['college']; ?>" readonly>
    </fieldset>
    ...
    <fieldset>
        ...
        <button type="button" onclick="addDescriptionToLastStrategicTask('strategic_tasks')">Add Success Indicator
            (Target + Measures)</button>
    </fieldset>
    ...
    <fieldset>
        ...
        <button type="button" onclick="addDescriptionToLastCoreTask()">Add Success Indicator (Target +
            Measures)</button>
    </fieldset>
    ...
    <fieldset>
        ...
        <button type="button" onclick="addDescriptionToLastSupportTask('support_tasks')">Add Success Indicator (Target +
            Measures)</button>
    </fieldset>
...
<script>
    ...
    function addDescriptionToLastStrategicTask() {
        ...
        // Rex edited:
        // SOLVES: should not show the ouputs input if the appended child is a dispcription.
        newTaskNameInput.setAttribute('hidden', true); // Make the task name read-only
        var newTaskNameInputLabel = newTask.querySelector('label[for="strategic_task_name"]');
        newTaskNameInputLabel.hidden = true; // Make the task name label hidden

        const newSibling = document.createElement('div'); // Create the new sibling
        newSibling.textContent = "";
        newSibling.style.width = "500px"; // Example styling
        newTaskNameInput.insertAdjacentElement('afterend', newSibling); // Append after the target
    ...
    function addDescriptionToLastCoreTask() {
        ...
        // SOLVES: should not show the ouputs input if the appended child is a dispcription.
        newTaskNameInput.setAttribute('hidden', true); // Make the task name read-only
        var newTaskNameInputLabel = newTask.querySelector('label[for="core_task_name"]');
        newTaskNameInputLabel.hidden = true; // Make the task name label hidden
    ...
    function addDescriptionToLastSupportTask() {
        ...
        // SOLVES: should not show the ouputs input if the appended child is a dispcription.
        newTaskNameInput.setAttribute('hidden', true); // Make the task name read-only
        var newTaskNameInputLabel = newTask.querySelector('label[for="support_task_name"]');
        newTaskNameInputLabel.hidden = true; // Make the task name label hidden
