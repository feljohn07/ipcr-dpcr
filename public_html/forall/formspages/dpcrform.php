...
// Fetch the firstname, middlename, and lastname of the VPAAQA and College President
$sql_vpaa = "SELECT firstname, middlename, lastname, role FROM usersinfo WHERE role IN ('VPAAQA', 'College President')"; 
...
<body>
    <div class="container">
        ...
        <table class="review-table">
            ...
            <tr>
                <td><strong class="highlighted"><?php echo strtoupper($vpaa_firstname . ' ' . $vpaa_middlename . ' ' . $vpaa_lastname); ?></strong><br>Immediate Supervisor</td>
                <td></td>
                <td><strong class="highlighted"><?php echo strtoupper($collegePresident_firstname . ' ' . $collegePresident_middlename . ' ' . $collegePresident_lastname); ?></strong><br>College President</td>
                <td></td>
            </tr>
        </table>
        <table class="review-table">
        ...
        <table class="review-table">
                <tr>
                    <td style="border-top: none; border-left: 1px solid black; border-right: 1px solid black; padding: 0;">
                       <strong class="highlighted"><?php echo strtoupper(htmlspecialchars($_SESSION['firstname']) . ' ' . htmlspecialchars($_SESSION['middlename']) . ' ' . htmlspecialchars($_SESSION['lastname'])); ?></strong>
                    </td>

                    <td style="border-top: none; border-left: 1px solid black; border-right: 1px solid black; padding: 0;">
                        <strong class="highlighted"><?php echo strtoupper($vpaa_firstname . ' ' . $vpaa_middlename . ' ' . $vpaa_lastname); ?></strong>
                    </td>
                    ...
                    <td style="border-top: none; border-left: 1px solid black; border-right: 1px solid black; padding: 0;">
                        <strong class="highlighted"><?php echo strtoupper($collegePresident_firstname . ' ' . ($collegePresident_middlename ? $collegePresident_middlename . ' ' : '') . $collegePresident_lastname); ?></strong>
                    </td>
                </tr>
                <tr>
